// Version helpers for ignite-api CI releases — keep in sync with mobile/ignite/scripts/resolve-app-version.mjs
...
export function resolveReleaseTitle(prefix = "ignite-api") {
